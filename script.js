...
const copy = {
  en: {
    skip:"Skip to content", languageLabel:"Language", eyebrow:"Clinical prediction model", subtitle:"A clinical calculator to estimate the probability of primary sclerosing cholangitis (PSC) in adults with sclerosing cholangitis.", tabsLabel:"PSC-DM sections", tabCalculator:"Calculator", tabInformation:"Information", tabReferences:"References", calculateTitle:"Calculate PSC probability", intro:"Enter the clinical features available at diagnosis or first specialist assessment.", age:"Age at diagnosis", years:"years", ibd:"Inflammatory bowel disease (IBD)", surgery:"Previous hepato-pancreato-biliary surgery", autoimmune:"Other autoimmune comorbidities", family:"Family history of autoimmune disease", pancreas:"Pancreatic abnormalities on MRI or CT", yes:"Yes", no:"No", reset:"Reset", calculate:"Calculate", resultLabel:"Predicted probability of PSC", ageHelp:"Age in completed years at the time of sclerosing cholangitis diagnosis (e.g. 32 years and 8 months = 32 years).", ibdHelp:"Select Yes if the patient has inflammatory bowel disease, including ulcerative colitis or Crohn’s disease.", surgeryHelp:"Select Yes for surgery involving the liver, pancreas, or biliary tree before assessment.", autoimmuneHelp:"Select Yes for a diagnosed autoimmune condition other than inflammatory bowel disease.", familyHelp:"Select Yes if the patient has a first-degree relative with a known autoimmune disease.", pancreasHelp:"Select Yes if MRI or CT reported a pancreatic abnormality.", aboutTitle:"About PSC-DM", aboutText:"PSC-DM combines six routinely available clinical variables: age at diagnosis, IBD, previous hepato-pancreato-biliary surgery, other autoimmune comorbidities, family history of autoimmune disease, and pancreatic abnormalities.", equation:"PSC-DM = 6.6417 − 0.1212×Age + 4.9673×IBD − 2.5868×Surgery + 2.2197×Autoimmunity + 2.3572×Family history − 2.5001×Pancreas", probabilityEquation:"Probability of PSC = exp(PSC-DM) / [1 + exp(PSC-DM)]", clinicalTitle:"Clinical use", clinicalText:"PSC-DM is provided for informational purposes only and should not be used as a standalone tool for diagnosis or treatment decisions. It is intended to support clinical judgement. Atypical or discordant presentations should prompt specialist review and appropriate investigation for secondary causes of sclerosing cholangitis.", privacy:"All calculations run locally in your browser. This website does not transmit or store patient information.", patientTitle:"Patient information", patientText:"For patients and relatives of those with PSC, further information is available from:", english:"English", italian:"Italian", referencesTitle:"References", derivedIn:"PSC-DM uses the equation derived in:", citationPending:"Final journal citation will be added when available.", referAlso:"Please refer also to:", disclaimer:"For research and clinical decision-support purposes. Not a substitute for specialist assessment.", credit:"Created by Miki Scaravaglio", high:"Using the prespecified 0.50 threshold, this result falls in the PSC-predicted range. Interpret alongside the full clinical assessment.", low:"Using the prespecified 0.50 threshold, this result falls below the PSC-predicted range. Consider secondary causes and interpret alongside the full clinical assessment.", title:"PSC-DM | Primary Sclerosing Cholangitis Calculator", description:"PSC-DM calculator: estimate the probability of primary sclerosing cholangitis using six clinical features."
  },
  it: {
